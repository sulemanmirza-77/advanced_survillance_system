...
/* Find an User
   http://0.0.0.0:5500/api/user/:id (http get method) */
router.get("/:id", getUser);
/* Update an Profile & Change the Profile Image
   http://0.0.0.0:5500/api/user/update/:id (http put method) */
router.put(
  "/update/:id",
...
/* Find an User's Videos
   http://0.0.0.0:5500/api/user/videos/:id (http get method) */
router.get("/videos/:id", getVideoByUser);
/* Subscribe an User
   http://0.0.0.0:5500/api/user/sub/:id (http put method) */
router.put("/sub/:id", getAccessToRoute, subscribeUser);
/* Unsubscribe an User
   http://0.0.0.0:5500/api/user/unSub/:id (http put method) */
